...
- **Tech Stack:** Power BI (ou Streamlit/Plotly), integrado a um modelo de série temporal (Prophet ou ARIMA).
- **Diferencial:** responder **“o que acontecerá?”** e não apenas **“o que aconteceu?”**.

### 5) O “Assistente Corporativo” (Chatbot NLP com RAG) — **Planejado**
- **O que é:** um chatbot que lê um PDF (ex.: manual de RH ou relatório financeiro) e responde perguntas sobre ele.
- **Tech Stack:** LangChain, OpenAI API (ou modelos locais via Ollama), Vector Database (ChromaDB).
- **Diferencial:** aplicação prática de **RAG (Retrieval-Augmented Generation)**, uma técnica muito valorizada para assistentes corporativos.
